...
namespace BackEnd_ASP.NET.Data
{
    public class ShUEHContext : DbContext
    {
        ...
        private void ShoeSeeding(ModelBuilder modelBuilder)
        {
            ...
            Guid[] shoeIds = {
                IDGiay_1, IDGiay_2, IDGiay_3, IDGiay_4, IDGiay_5,
                IDGiay_6, IDGiay_7, IDGiay_8, IDGiay_9, IDGiay_10,
            ...
            for (int i = 0; i < shoeIds.Length; i++)
            {
                ...
                int maxAdditionalSizes = rand.Next(2, 5);
                for (int j = 0; j <= maxAdditionalSizes; j++)
                {
                    ...
                    shoeDetails.Add(new ShoeDetail
                    {
                        Id = Guid.NewGuid(),
