...
const UserIntroduction = () => {
  ...
  return (
    <div className="user-introduction" id="user-introduction">
      ...
      <div className="line">
        <img
          className="line"
          src="/intro-line-decor.svg"
          alt="line-decor"
        ></img>
      </div>

      <div
        className={`product-introduction image-${imageIndex}`}
        ref={ref}
        style={productStyle}
      >
        <img
          className={`product-img image-${imageIndex} ${
        ...
        <div
          className={`black-circle-block border-circle image-${imageIndex}`}
        ></div>

        <div
          className={`product-add-block d-none d-sm-block image-${imageIndex}`}
        >
          <AddBlock id={data[0]?.id}></AddBlock>
        </div>
      </div>
      ...
      <div
        className="sub-product flex-center border-circle d-none d-lg-block"
        style={productStyle}
      >
        ...
        <img
          ...
          src={data[imageIndex]?.imageUrl || "/intro-sub-product.svg"}
          alt="sub-product"
        ></img>
        <div className="sub-product-add-block">
          <AddBlock id={data[0]?.id}></AddBlock>
        </div>
        <span className="sub-product--name">{data[0]?.name}</span>
        <div className="sub-product--price flex-center">{data[0]?.price}đ</div>
      </div>
    </div>
  );
};
