...
const Navbar = (props) => {
  ...
  const handleNavbarClick = (e) => {
    ...
    if (e.currentTarget.textContent === "Home") {
      const element = document.getElementById("user-introduction");
      if (element) {
        element.scrollIntoView({ behavior: "smooth" });
      }
    }

    if (e.currentTarget.textContent === "Brands") {
      const element = document.getElementById("products-home");
      if (element) {
        element.scrollIntoView({ behavior: "smooth" });
      }
    }
  ...
  return (
    <div className="navbar-block">
      <marquee
        direction="right"
        scrollamount="15"
        className="promotion text-center d-none d-sm-block"
      >
        ...
        <div className="tool-block">
          ...
          {user ? (
            <>
              ...
              <div
                className="tool-item d-block d-md-none"
                onClick={() => setOpenSideBar(true)}
              >
                <img src="/navbar-menu-wrapper.svg" alt="" />
              </div>
              <div
                className="tool-item d-none d-md-block"
                onClick={() => navigate("/profile/favour")}
              >
                <img src="/nav-favor.svg" alt="" />
              </div>
              <div
                className="tool-item btn btn-logout d-none d-md-block"
        ...
        <div className="sidebar-overlay">
          ...
          <div className="sidebar-btn">
            {!user ? (
              ...
              <>
                <div
                  className="sidebar-btn-item sidebar-btn-login"
                  onClick={() => {
                    setOpenSideBar(false);
                    setOpenLogin(true);
                  }}
                ...
                <div
                  className="sidebar-btn-item sidebar-btn-register"
                  onClick={() => {
                    setOpenSideBar(false);
